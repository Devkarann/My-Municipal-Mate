...
const BoxesLinks = [
  ...
  {
    links: "https://www.puneonline.in/guide/libraries-in-pune",
    para: "Library",
  },
  { links: "https://www.pmc.gov.in/en/electrical", para: "Electricity" },
  {
    links: "https://www.pmc.gov.in/en/school-and-learning-centers",
    para: "School",
  },
  { links: "https://www.pmc.gov.in/en/garden", para: "Park" },
  {
    links: "https://www.pmc.gov.in/en/local-transportation-0",
    para: "Transit",
  },
];
    ...
    <div className="about-container" style={{ backgroundColor: "whitesmoke" }}>
      <div className="truck-about">
        ...
        <div className="truck-det">
          ...
          <div className="tagline-highlight-two">
            <span className="tagline-main">{t("taglineTwo")}</span>
          </div>
        </div>
      </div>
      ...
      <div className="about-part">
        ...
        <div>
          <img
            src={logo2}
            style={{ height: "200px", width: "280px", marginTop: "70px" }}
          ></img>
        </div>
      </div>
